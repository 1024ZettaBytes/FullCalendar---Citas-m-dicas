        ...
        $(document).ready(function () {
            $('#calendar').fullCalendar({
                ...
                events: [
                    ...
                    {
                        title: '<?php echo $cita['Titulo']; ?>',
                        start: '<?php echo $cita['Fecha'] . ' ' . $cita['Hora']; ?>',
                        <?php
                        $duracion = $cita['Duracion'];
                        $fechaFin = new DateTime($cita['Fecha'] . ' ' . $cita['Hora']);
                        $fechaFin->modify("+{$duracion} minutes");
                        ?>
                        end: '<?php echo date_format($fechaFin, "Y-m-d H:i:s") ?>',
                        medico: '<?php echo $cita['Medico']?>',
                        sala: '<?php echo $cita['Sala']?>',
                        estudio: '<?php echo $cita['Estudio']?>',
                        gabinete: '<?php echo $cita['Gabinete']?>',
                        estatus: '<?php echo $cita['Estatus']?>',
                        ordenServicio: '<?php echo $cita['OrdenServicio']?>',
                        nota: '<?php echo $cita['Nota']?>'
                    },
                    <?php } ?>
                ...
                <form class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="nota" class="col-sm-2 control-label">Nota:</label>
                            <div class="col-sm-10">
                                <textarea name="nota" cols="40" rows="5" class="form-control" id="nota" readonly></textarea>
                            </div>
                        </div>
